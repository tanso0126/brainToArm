...
```text
f8dbe7682637322c75f060de644ef70a7eda6c05ef0a744268f02835f78d213d
```
...
- 별도 검증 행동 정확도: 99.9474%
- 센서 누락·영상 오차·초음파 오차를 넣은 무작위 작업:
  10,000/10,000 완료, 평균 17.6103 상위 프레임
- 결정론적 작업: 1,000/1,000 완료, 평균 15.371 상위 프레임
...
구형 물체는 평행 집게에서 굴러 빠졌습니다. 이 실패를 성공으로 바꾸거나
평가에서 숨기지 않았습니다. 현재 정책을 실물에 적용할 때는 먼저 상자형·
원기둥형 물체를 사용하고, 구형 물체는 오목한 패드나 별도 파지 전략을
추가하기 전까지 지원 대상으로 주장하지 않습니다.
